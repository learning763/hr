<nav
    style="background: linear-gradient(135deg, #1a3c34 0%, #0f2c26 100%); box-shadow: 0 4px 20px rgba(0,0,0,0.1); padding: 0 32px; height: 70px; display: flex; align-items: center; justify-content: space-between; position: sticky; top: 0; z-index: 100; border-bottom: 1px solid rgba(255,255,255,0.1);">
    <!-- Logo Section -->
    <div style="display: flex; align-items: center; gap: 12px;">
        <div
            style="width: 40px; height: 40px; background: rgba(255,255,255,0.15); border-radius: 12px; display: flex; align-items: center; justify-content: center; backdrop-filter: blur(10px);">
            <i class="fas fa-shield-alt"
                style="font-size: 22px; color: #ffd700; text-shadow: 0 2px 4px rgba(0,0,0,0.2);"></i>
        </div>
        ...
        <div style="height: 30px; width: 1px; background: #ffffff; margin-left: 8px;"></div>
        <div style="font-size: 30px; color: #ffffff; letter-spacing: 0.5px;">
    ...
    <div style="display: flex; align-items: center; gap: 20px;">
        <!-- Date/Time Display -->
        <div
            style="display: flex; align-items: center; gap: 12px; padding: 6px 14px; background: rgba(255,255,255,0.08); border-radius: 30px; backdrop-filter: blur(10px);">
        ...
        <!-- Logout Button -->
        <div id="logoutBtnNav"
            style="display: flex; align-items: center; gap: 8px; padding: 8px 16px; background: rgba(255,255,255,0.1); border-radius: 30px; cursor: pointer; font-size: 13px; font-weight: 500; color: #ffffff; transition: all 0.3s ease; border: 1px solid rgba(255,255,255,0.15);"
        ...
        <div id="userAvatarNav"
            style="width: 42px; height: 42px; background: linear-gradient(135deg, #ffd700 0%, #ffed4e 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0,0,0,0.2); border: 2px solid rgba(255,255,255,0.3);"
...
<div id="userDropdownMenu"
    style="display: none; position: fixed; top: 75px; right: 32px; background: #ffffff; border-radius: 16px; box-shadow: 0 10px 40px rgba(0,0,0,0.15); z-index: 1000; min-width: 280px; overflow: hidden; animation: slideDown 0.2s ease;">
    <div style="padding: 20px; background: linear-gradient(135deg, #1a3c34 0%, #0f2c26 100%); color: white;">
        <div style="display: flex; align-items: center; gap: 12px;">
            <div
                style="width: 50px; height: 50px; background: #ffd700; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
    ...
    <div style="padding: 12px 0;">
        <div
            style="padding: 10px 20px; display: flex; align-items: center; gap: 12px; border-bottom: 1px solid #f0f0f0;">
        ...
        <div style="padding: 12px 20px; border-top: 1px solid #f0f0f0; margin-top: 8px;">
            <div id="dropdownLogoutBtn"
                style="display: flex; align-items: center; gap: 10px; padding: 8px 12px; background: #fef2f2; border-radius: 10px; cursor: pointer; transition: all 0.2s; color: #dc2626;"
