...
$pageSubtitle = "Manage office events, meetings, trainings, and activities";
$activePage = "events";
    ...
    try {
        ...
        if ($action === 'create_event') {
            ...
            $result = $stmt->execute([
                ...
                $end_date ?: null, $location, $priority, 
                $current_personnel_id, $current_user_id
            ]);
        ...
        if ($action === 'update_event') {
            ...
            $result = $stmt->execute([
                $title, $description, $event_type, $start_date,
                $end_date ?: null, $location, $priority, $status, $id
            ]);
...
<div class="stats-grid">
    ...
    <div class="stat-card">
        ...
        <div>
            <div class="stat-value" id="ongoingCount"><?php echo $stats['ongoing']; ?></div>
    ...
    <div class="stat-card">
        ...
        <div>
            <div class="stat-value" id="totalInRange">0</div>
...
<div class="search-section">
    <div class="search-container">
        ...
        <input type="text" id="searchInput" class="search-input" placeholder="Search by title, location, or description...">
            ...
            <form id="eventForm">
                ...
                <div class="form-grid">
                    ...
                    <div class="input-field full-width">
                        ...
                        <textarea id="description" name="description" rows="4" placeholder="Event details, agenda, notes..."></textarea>
                    </div>
                </div>
...
<style>
    ...
    .btn-add, .btn-export, .btn-filter-date, .btn-reset {
        padding: 10px 20px;
        border-radius: 8px;
        cursor: pointer;
        font-size: 14px;
    ...
    .status-ongoing { background: #fed7aa; color: #92400e; }
    ...
    @media (max-width: 768px) {
        ...
        .filter-buttons-row { justify-content: stretch; }
        .filter-buttons-row button { flex: 1; }
    }
</style>
